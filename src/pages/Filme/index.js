...
export default function Filme(){
    ...
    function salvaFilme(){
        ...
        //Se o filme já estiver salvo com este mesmo ID precisa ignorar...
        const hasFilme = filmesSalvos.some( (filmeSalvo) => filmeSalvo.id === filme.id )

        if(hasFilme){
            toast.info('Você já salvou esse filme!')
           //Caso deseje mostrar a msg como um erro, basta trocar para: toast.error('Você já salvou esse filme!')
            return;
